[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/S3030Pkg-$(ARCH)
...
!endif
  ...
  gMTKPlatformTokenSpaceGuid.MpParkMailboxBase|0x80100000
...
!endif
  ...
  gMTKPlatformTokenSpaceGuid.PcdSerialRegisterBase|0x02020000   # UART1
  gMTKPlatformTokenSpaceGuid.PcdKdUartInstance|1                # UART1

  gMTKPlatformTokenSpaceGuid.PcdPhysicalMemoryMaximumCapacity|0x40000
...
!endif
  ...
  EfiResetSystemLib|S3030Pkg/Library/MTKResetSystemLib/MTKResetSystemLib.inf
