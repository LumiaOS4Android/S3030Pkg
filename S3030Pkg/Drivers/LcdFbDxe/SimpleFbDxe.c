    ...
    IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
  ...
  /* Sanity check */
  if (LcdIfFrameBufferAddr == 0 || LcdIfFrameBufferWidth == 0 ||
      LcdIfFrameBufferHeight == 0) {
  ...
  mDisplay.Mode->Info->HorizontalResolution = LcdIfFrameBufferWidth;
  mDisplay.Mode->Info->VerticalResolution   = LcdIfFrameBufferHeight;
